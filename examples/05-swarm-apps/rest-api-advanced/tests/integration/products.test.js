...
describe('Product Endpoints', () => {
  ...
  describe('GET /api/products/:id', () => {
    ...
    it('should get product by ID', async () => {
      const response = await request(server).get(`/api/products/${testProduct._id}`).expect(200);
    ...
    it('should return 404 for non-existent product', async () => {
      ...
      const response = await request(server).get(`/api/products/${fakeId}`).expect(404);
    ...
    it('should return 400 for invalid ID format', async () => {
      const response = await request(server).get('/api/products/invalid-id').expect(400);
  ...
  describe('POST /api/products', () => {
    ...
    it('should not create product without authentication', async () => {
      await request(server).post('/api/products').send(newProductData).expect(401);
    });
    ...
    it('should validate required fields', async () => {
      ...
      expect(response.body.errors).toContainEqual(expect.objectContaining({ field: 'price' }));
      expect(response.body.errors).toContainEqual(expect.objectContaining({ field: 'category' }));
    });
  ...
  describe('Special Product Endpoints', () => {
    describe('GET /api/products/featured', () => {
      it('should get featured products', async () => {
        const response = await request(server).get('/api/products/featured').expect(200);
    ...
    describe('GET /api/products/popular', () => {
      it('should get popular products', async () => {
        const response = await request(server).get('/api/products/popular').expect(200);
    ...
    describe('GET /api/products/categories/list', () => {
      it('should get all categories', async () => {
        ...
        const response = await request(server).get('/api/products/categories/list').expect(200);
