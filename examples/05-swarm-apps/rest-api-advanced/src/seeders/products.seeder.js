...
function generateRandomReviews() {
  ...
  const reviewTemplates = [
    ...
    {
      rating: 3,
      comments: ['Decent product.', 'Average quality.', "It's okay.", 'Could be better.'],
    },
    {
      rating: 2,
      comments: ['Not satisfied.', 'Below expectations.', 'Quality issues.', 'Disappointed.'],
    },
    {
      rating: 1,
      comments: ['Poor quality.', 'Do not recommend.', 'Waste of money.', 'Very disappointed.'],
    },
  ];
