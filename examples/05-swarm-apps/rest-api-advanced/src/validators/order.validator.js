...
const createOrderValidation = [
  ...
  body('items.*.variant').optional().isObject().withMessage('Variant must be an object'),
...
const addTrackingValidation = [
  ...
  body('estimatedDelivery').optional().isISO8601().withMessage('Invalid date format').toDate(),
];
