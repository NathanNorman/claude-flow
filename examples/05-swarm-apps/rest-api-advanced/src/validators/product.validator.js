...
const createProductValidation = [
  ...
  body('specifications.*.key').trim().notEmpty().withMessage('Specification key is required'),

  body('specifications.*.value').trim().notEmpty().withMessage('Specification value is required'),
  ...
  body('featured').optional().isBoolean().withMessage('Featured must be a boolean').toBoolean(),
];
...
const searchProductsValidation = [
  ...
  query('inStock').optional().isBoolean().withMessage('In stock must be a boolean').toBoolean(),
