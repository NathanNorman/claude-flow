...
class AblationAnalyzer:
    ...
    def evaluate_pipeline(
        self, pipeline: Dict[str, Any], X: np.ndarray, y: np.ndarray
        ...
        if self.evaluation_metric == "accuracy":
            ...
            scores = cross_val_score(
                model, X_processed, y, cv=cv, scoring="neg_mean_squared_error"
            )
        ...
        for config in ablation_configs:
            ...
            try:
                ...
                if self.baseline_performance is None:
                    ...
                    baseline_value = self.baseline_performance[
                        f"{self.evaluation_metric}_mean"
                    ]
                ...
                logger.info(
                    f"  Config: {config_desc} | Impact: {impact_score:.4f} | "
    ...
    def run_full_ablation(
        self,
        components_to_test: Dict[str, List[Dict[str, Any]]],
        X: np.ndarray,
        y: np.ndarray,
    ) -> Dict[str, Any]:
        """
        ...
        logger.info(
            f"Baseline {self.evaluation_metric}: "
        ...
        analysis_summary = {
            ...
            "highest_impact_component": (
                ranked_components[0][0] if ranked_components else None
            ),
